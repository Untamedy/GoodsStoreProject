...
<html lang="en">
    ...
    <body>
        ...
        <div id="header">
            ...
            <a href="/goods/show" class="btn btn-info mr-1" role="button">Show order</a>
                            ...
                            <tbody>
                                ...
                                <%
                                    for (GoodsDto g : goods) {
                                        ...
                                        out.print("<td> <a href=\"/goods/addToOrder/" + dto.getOrgCode() + "/" + g.getCode() + "\"class=\"btn btn-info mr-1\" role=\"button\">Add to order</a></td>");
                                        out.print("<td> <a href=\"/goods/removeGoods/" + dto.getOrgCode() + "/" + (int) request.getAttribute("group") + "/" + g.getCode() + "\" class=\"btn btn-info mr-1\" role=\"button\">Delete</a></td>");
                                        out.print("<tr>");
                                    }
                                %>
        ...
        <div name="editGoods" class="modal" id="editGoods">
            <div class="modal-dialog">
                <div class="modal-content">               
                    ...
                    <div class="modal-body">
                        <form id="editGoodsForm" role="form" method="POST" action="/goods/editGoods">
                            <%
                                out.print("<input type=\"hidden\" name=\"orgCode\" value=\"" + dto.getOrgCode() + "\">");
                            %>
        ...
        <div name="createIncomeDoc" class="modal" id="createIncome">
            <div class="modal-dialog">
                <div class="modal-content">               
                    ...
                    <div class="modal-body">
                        <form id="createIncomeForm" role="form" modelAttribute="income" method="POST" action="/goods/input">
                            <
                            <div class="form-group">
                                <%
        ...
        <div name="saleGoodsDoc" class="modal" id="saleGoods">
            <div class="modal-dialog">
                <div class="modal-content">               
                    ...
                    <div class="modal-body">
                        <form id="saleGoodsForm" role="form" modelAttribute="income" method="POST" action="/goods/sale">
